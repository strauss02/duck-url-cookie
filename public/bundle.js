...
var Elements = function Elements() {
  (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Elements);
};

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "inputField", document.getElementById('url_input'));

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "submitBtn", document.getElementById('submit-btn'));

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "sampleText", document.querySelector('h3'));

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "copyButton", document.getElementById('btn-copy-url'));

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "alertBox", document.getElementById('alert-box'));

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "alertSection", document.getElementById('alert-container'));

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "newUrlBox", document.getElementById('new-url'));

(0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(Elements, "logInButton", document.querySelector('.login-button'));
...
var LoginModal = document.querySelector('.login-modal-container');
...
function handleModalDisplayLoginClick() {
  ...
  _utility__WEBPACK_IMPORTED_MODULE_4__["default"].toggleVisibility(modalContentSignup, false);
}

function handleModalDisplaySignupClick() {
  _utility__WEBPACK_IMPORTED_MODULE_4__["default"].toggleVisibility(modalContentLogin, false);
  _utility__WEBPACK_IMPORTED_MODULE_4__["default"].toggleVisibility(modalContentSignup, true);
}
...
function _handleSignupClick() {
  _handleSignupClick = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {
...
var Utility = /*#__PURE__*/function () {
  function Utility() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, Utility);
  }

  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Utility, null, [{
    key: "toggleVisibility",
    value: function toggleVisibility(element, isVisible) {
    ...
    value: function displayAlert(message) {
      _elements__WEBPACK_IMPORTED_MODULE_2__["default"].alertBox.innerText = message;
    }
  }, {
    key: "toggleAlertStyle",
    value: function toggleAlertStyle(isError) {
      if (document.querySelector('.success') && isError) {
        _elements__WEBPACK_IMPORTED_MODULE_2__["default"].alertBox.classList.toggle('failure');
        _elements__WEBPACK_IMPORTED_MODULE_2__["default"].alertBox.classList.remove('success');
      } else if (document.querySelector('.failure') && !isError) {
        _elements__WEBPACK_IMPORTED_MODULE_2__["default"].alertBox.classList.toggle('success');
        _elements__WEBPACK_IMPORTED_MODULE_2__["default"].alertBox.classList.remove('failure');
      }
    }
  }]);
...
/* harmony import */ var _elements_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./elements.js */ "./src/elements.js");
...
var baseURL = window.location.href; // TODO: DECIDE BASE URL BASED ON ENV

var inputField = document.getElementById('url_input');
var submitBtn = document.getElementById('submit-btn');
var sampleText = document.querySelector('h3');
var copyButton = document.getElementById('btn-copy-url');
var alertBox = document.getElementById('alert-box'); // const newUrlsection = document.getElementById('new-url-container')

var alertSection = document.getElementById('alert-container');
var newUrlBox = document.getElementById('new-url');
...
function _handleSubmit() {
  _handleSubmit = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(e) {
    var inputURL, newURL;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            newUrlBox.innerText = "".concat(baseURL, "/").concat(newURL);
            newUrlBox.href = "".concat(baseURL).concat(newURL);
          ...
          case 17:
            ...
            displayAlert(_context.t0.response ? _context.t0.response.data : _context.t0);
            toggleVisibility(alertSection, true);
